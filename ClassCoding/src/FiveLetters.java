...
public class FiveLetters {
    ...
    public static boolean quickCheck(String word) throws FileNotFoundException {
        Scanner sc = new Scanner(new File("words.txt"));
        while (sc.hasNextLine())
            if (sc.nextLine().toLowerCase().equals(word.toLowerCase()))
                return true;
        return false;
    }
    ...
    public static void main(String[] args) throws FileNotFoundException {
       ...
       // System.out.println(isValidBinary("hello", fiveLetters));
        System.out.println(quickCheck("hello"));
    }
}
